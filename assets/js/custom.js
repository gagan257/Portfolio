          ...
          if (check == 0) {
            ...
            $.ajax({
              ...
              if (resp == 1) {
                ...
                errroTarget.html(
                  '<p style="color:green;">Form Submitted Successfully, Reloading...</p>'
                );
              }
            });
          }
...
// Show More Projects Function (outside jQuery wrapper for global access)
var projectsShown = 6; // Initially 6 projects are visible
var projectsPerLoad = 6; // Load 6 more at a time

function showMoreProjects() {
  var hiddenProjects = document.querySelectorAll('.project-item.project-hidden');
  var showCount = 0;

  for (var i = 0; i < hiddenProjects.length && showCount < projectsPerLoad; i++) {
    if (hiddenProjects[i].style.display === 'none') {
      ...
      hiddenProjects[i].style.transform = 'translateY(20px)';
  ...
  var remainingHidden = document.querySelectorAll('.project-item.project-hidden');
